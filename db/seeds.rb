...
def places_query_generator(normalized_input)
  ...
  api_key = "&key=AIzaSyA71ylisovwHOzO13d3yj_eaX5GB-TbQ4Q"
  string = ""
...
def get_picture(query)
  photos_url = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=1600&photoreference=#{query}&key=AIzaSyA71ylisovwHOzO13d3yj_eaX5GB-TbQ4Q"
  photos_url
end
